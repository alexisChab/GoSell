...
class Stock(Base):
    ...
    utilisateur = relationship("Utilisateur", back_populates="stocks")
    type_produit = relationship("TypeProduit")
    couts = relationship("StockCout", back_populates="stock", cascade="all, delete-orphan")